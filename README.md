...
PyTorch code for our TIP 2022 paper “Video Super-Resolution via a Spatio-Temporal Alignment Network” [Paper]([Video Super-Resolution via a Spatio-Temporal Alignment Network | IEEE Journals & Magazine | IEEE Xplore](https://ieeexplore.ieee.org/document/9700735)) or [Researchgate](https://www.researchgate.net/publication/358314922_Video_Super-Resolution_via_a_Spatio-Temporal_Alignment_Network).
...
This project is based on [[Learning Blind Video Temporal Consistency]([phoenix104104/fast_blind_video_consistency: Learning Blind Video Temporal Consistency (ECCV 2018) (github.com)](https://github.com/phoenix104104/fast_blind_video_consistency))] and our filter  adaptive alignment module is based on[[STFAN](https://github.com/sczhou/STFAN)]. Welcome to cite them !
